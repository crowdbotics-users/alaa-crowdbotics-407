...
urlpatterns = [
    ...
    path("users/<int:profile_id>/follow/", view=api_views.FollowUser.as_view(), name="follow_user"),
    path("users/<int:profile_id>/unfollow/", view=api_views.UnfollowUser.as_view(), name="unfollow_user"),
    path("users/<str:username>/followers/", view=api_views.UserFollowers.as_view(), name="user_followers"),
    path("users/<str:username>/following/", view=api_views.UserFollowing.as_view(), name="user_following"),
    path("users/search/", view=api_views.Search.as_view(), name="search"),
    path("users/<str:username>/", view=api_views.UserProfile.as_view(), name="user_profile"),
    path("users/<str:username>/password/", view=api_views.ChangePassword.as_view(), name="change_password"),
    ...
    path("<int:image_id>)/comments/", view=api_views.CommentOnImage.as_view(), name="comment_image"),
    path(
